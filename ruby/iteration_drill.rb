...
animals_to_be_checked = ["Andean Cat", "Dodo", "Saiga Antelope"]

checked_animals = {}

p animals_to_be_checked

animals_to_be_checked.map do |animal_to_check|
  checked_animals[animal_to_check] = extinct_animals.keys.include? animal_to_check
end
...
p extinct_animals.rassoc(extinct_animals["Passenger Pigeon"])
